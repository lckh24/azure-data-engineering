...
-- MAGIC %python
-- MAGIC dailyPricingStramingSourceFolderPath = "abfss://bronze@lckudadatalakehousedev.dfs.core.windows.net/daily-pricing-streaming-source-data"
...
-- MAGIC WHERE DATE_OF_PRICING='02/01/2023'""")
